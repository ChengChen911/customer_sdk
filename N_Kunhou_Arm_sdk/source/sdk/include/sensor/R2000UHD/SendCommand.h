...
public:
	...
	STRING Get_Parameter_List(STRING ip);
	STRING set_scan_direction(STRING ip,STRING parameter="ccw");
	STRING Get_scanoutput_config(STRING ip);
	void Clear_Handle();

	STRING SendComm_test(STRING command);
public:
