/*************************************************************************
	...
	> Author:xiangzebo 
	> Mail: 
	> Created Time: Mon 24 Sep 2018 06:38:32 PM PDT
 ************************************************************************/
...
namespace SickToolbox {
    ...
    public:
        ...
        constexpr static const double SICK_MAX_SCAN_ANGULAR_RESOLUTION = 0.125;                       ///< Minimum valid separation between laser pulses in active scan ares (deg)
        constexpr static const double SICK_DEGREES_PER_MOTOR_STEP = 0.0625;                           ///< Each odometer tick is equivalent to rotating the scan head this many degrees
        ...
        static const std::string SETLANDMARK_DATAFORMAT_COMMAND_TYPE;
        static const std::string SETLANDMARK_DATAFORMAT_COMMAND;
        ...
        void SetDataNavigation(int format, int showoptparam, int landmarkfilter);
