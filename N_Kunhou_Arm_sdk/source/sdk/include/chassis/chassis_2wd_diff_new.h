#ifndef _CHASSIS_2WD_DIFF_NEW_CHENG_
#define _CHASSIS_2WD_DIFF_NEW_CHENG_

#include "chassis_base.h"

class Chassis_2wd_diff_new : Chassis_base
{
public:

	Chassis_2wd_diff_new();
	~Chassis_2wd_diff_new();
...
#endif//_CHASSIS_2WD_DIFF_NEW_CHENG_
