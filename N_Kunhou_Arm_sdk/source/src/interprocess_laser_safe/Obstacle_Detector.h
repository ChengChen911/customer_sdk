...
public:
	...
	void tim310_preProcessSpeed(const F32 &vx,const F32 &vy,const F32 &vw,NS_Laser_Safe::SHAPE_DIR &dir);
	NS_Laser_Safe::SHAPE_DIR get_dir();
...
private:
    ...
    void save_laser(const SLaser &laser_data,NS_Laser_Safe::SHAPE_DIR dir);
private:
	...
	int obstacle_warn_;
	NS_Laser_Safe::SHAPE_DIR tim310_last_dir_;
};
